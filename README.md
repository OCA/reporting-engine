...
--- | --- | ---
[bi_view_editor](bi_view_editor/) | 10.0.1.0.0 | Graphical BI views builder for Odoo
[report_py3o](report_py3o/) | 10.0.2.0.0 | Reporting engine based on Libreoffice (ODT -> ODT, ODT -> PDF, ODT -> DOC, ODT -> DOCX, ODS -> ODS, etc.)
...
[report_qweb_pdf_watermark](report_qweb_pdf_watermark/) | 10.0.1.0.1 | Add watermarks to your QWEB PDF reports
