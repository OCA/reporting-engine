...
class TestQwebDecimalPrecision(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        # Create a test decimal precision record
        cls.dp_qweb_rec = cls.env["decimal.precision.qweb"].create(
            {
    ...
    def test_record_to_html(self):
        ...
        # Test without qweb decimal precision record (default is 6 digits)
