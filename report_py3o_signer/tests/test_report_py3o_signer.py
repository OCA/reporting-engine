...
class TestReportPy3oSignerCase(TransactionCase):
    def setUp(self):
        ...
        self.report = self.env.ref("report_py3o.res_users_report_py3o").with_context(
...
class TestReportPy3oSigner(TestReportPy3oSignerCase):
    def test_report_py3o_signer(self):
        ...
        self.report._render_py3o("py3o_user_info", user_ids)
        ...
        self.report._render_py3o(report_ref, user_ids)
