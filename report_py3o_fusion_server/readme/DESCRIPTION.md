This module was written to connect to a local LibreOffice daemon that handle
format conversion instead of spawning a new LibreOffice for each conversion.
