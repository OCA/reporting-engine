...
- Create a Report or edit existing report from Settings \> Users &
  Companies \> Batch Reports
- Add sequence number and select parent report or design your own batch
  report.
- Select subreport to add reports and save it.

## 2st Way

- Active developer mode. Go to Settings \> Technical \> Actions \>
  Reports.
