...
* Modified jPdfSign: © 2015 Antonio Espinosa - License `MPL <http://www.mozilla.org/MPL>`___ or `LGPL2 <http://www.gnu.org/licenses/old-licenses/lgpl-2.0.html>`___ (inherited from iText) - static/src/java/JPdfSign.java
